...
},{"./game.js":4,"babel/polyfill":8}],2:[function(require,module,exports){
"use strict";
...
var Circle = (function () {
    function Circle(context) {
        ...
        var r = arguments[3] === undefined ? 50 : arguments[3];
    ...
    _createClass(Circle, {
        ...
        _getColor: {
            value: function _getColor() {
                var colours = ["#34b827", "#F76C27", "#6D9DD1", "#e76395", "#cade08", "#22b1bd", "#7E45D3", "#E73F3F"];
    ...
    _createClass(Game, {
        ...
        addElement: {
            value: function addElement() {
                var c = new Circle(this.board.getContext());
                var position = this.board.randomPoint();
                position.radius = 50;
...
},{"./board":2,"./circle":3}],5:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/shim":6,"regenerator-babel/runtime":7}],6:[function(require,module,exports){
/**
 * Core.js 0.6.1
